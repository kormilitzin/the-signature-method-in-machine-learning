...
This repo is dedicated to the theory and practice of the signature method. This a novel and powerful method for sequential data representation and feature extraction derived from the theory of rough paths in stochastic analysis. 

The website is in erly stages of preparation, but we are working hard to fill in the content as soon as possible.
...
General overview and real-world examples from the founder of the signature method, <a href="https://en.wikipedia.org/wiki/Terry_Lyons_(mathematician)">Professor Terry Lyons</a>.
...
Let's kick off with basics of the signature method: [a path](intro-to_paths)
